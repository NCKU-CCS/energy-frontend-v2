      ...
      <div className={classNames('drbid-status-total-container-out')}>
        <div className={classNames('drbid-status-total-container-in')}>
          ...
          <div className={classNames('drbid-status-total-text-container')}>
            <div
              className={classNames('drbid-status-total-text-price-container')}
            >
              <div
                className={classNames('drbid-status-total-text-price-value')}
              >
                ${totalPrice.toFixed(0)}
              </div>
              <div
                className={classNames('drbid-status-total-text-price-title')}
              >
                {t('drbidpage.totalPrice')}
              </div>
            </div>
            <div
              className={classNames('drbid-status-total-text-volume-container')}
            >
              <div
                className={classNames('drbid-status-total-text-volume-value')}
              >
                {totalVolume.toFixed(0)}kWh
              </div>
              <div
                className={classNames('drbid-status-total-text-volume-title')}
              >
