...
const AddBidBtn: React.FC = () => {
  ...
  return (
    <div className={classNames('draccept-submit-addbidbtn-container-in')}>
      <button
        type="button"
        title="新增"
        className={classNames('draccept-submit-addbidbtn-btn')}
        onClick={() => setAdd(true)}
      >
        <img
          alt="add"
          src={`${process.env.PUBLIC_URL}/drBidPage/add-gray.png`}
          className={classNames('draccept-submit-addbidbtn-btn-img')}
        />
      </button>
      {add && (
        <div
          className={classNames('draccept-submit-addbidbtn-infobox-container')}
        >
          <div
            className={classNames('draccept-submit-addbidbtn-infobox-content')}
          >
            <div
              className={classNames(
                `draccept-submit-addbidbtn-infobox-header--${userType}`,
              )}
            >
              <button
                type="button"
                className={classNames(
                  'draccept-submit-addbidbtn-infobox-header-close',
                )}
            ...
            <div
              className={classNames('draccept-submit-addbidbtn-infobox-center')}
            >
              <div
                className={classNames(
                  'draccept-submit-addbidbtn-infobox-center-content',
                )}
              >
                <div
                  className={classNames(
                    'draccept-submit-addbidbtn-infobox-center-item-container',
                  )}
                >
                  <div
                    className={classNames(
                  ...
                  <div
                    className={classNames(
                      '.draccept-submit-addbidbtn-infobox-center-item-input',
                    )}
                  >
            ...
            <div
              className={classNames(
                `draccept-submit-addbidbtn-infobox-footer--${userType}`,
              )}
            >
              <button
                type="button"
                className={classNames(
                  'draccept-submit-addbidbtn-infobox-footer-leftbtn',
                )}
              ...
              <button
                type="button"
                className={classNames(
                  'draccept-submit-addbidbtn-infobox-footer-rightbtn',
                )}
